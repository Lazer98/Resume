  ...
  <v-main>
    ...
    <v-sheet width="600" class="mx-auto mt-5" color="transparent">
      ...
      <form ref="form" @submit.prevent="sendEmail">
        <v-text-field class="white-text" name="from_name" v-model="name" label="Ihr Name" required></v-text-field>
        <v-text-field class="white-text" name="from_email" v-model="email" label="Ihre EMail" type="email"
          required></v-text-field>
        <v-textarea class="white-text" name="message" v-model="message" label="Ihre Nachricht an mich!"
